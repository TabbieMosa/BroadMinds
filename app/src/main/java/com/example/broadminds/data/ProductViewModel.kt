package com.example.broadminds.data
...
class ProductViewModel(var navController: NavHostController, var context: Context) {
    ...
    fun saveProduct(productName: String, productemail: String, productideadescription: String) {
        var id = System.currentTimeMillis().toString()
        var productData = Product(productName, productemail, productideadescription, id)
    ...
    fun updateProduct(name: String, email: String, ideadescription: String, id: String) {
        var updateRef = FirebaseDatabase.getInstance().getReference()
            .child("Products/$id")
        progress.show()
        var updateData = Product(name,email  , ideadescription, id)
    ...
    fun saveProductWithImage(productName:String, productemail:String, ideadescription:String, filePath: Uri){
        var id = System.currentTimeMillis().toString()
        ...
        storageReference.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageReference.downloadUrl.addOnSuccessListener {
                    ...
                    var houseData = Upload(productName,productemail,
                        ideadescription,imageUrl,id)
